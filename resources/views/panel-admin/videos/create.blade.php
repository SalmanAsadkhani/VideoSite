                ...
                <div class="col-lg-12">
                    <div class="shop-breadcrumb">
                        ...
                        <div class="breadcrumb-main">
                            <h4 class="text-capitalize breadcrumb-title">افزودن ویدیو</h4>
                            <div class="breadcrumb-action justify-content-center flex-wrap">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{route("panel.show.all")}}"><i class="uil uil-estate"></i>ویدیوها</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">افزودن ویدیو</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="product-add global-shadow px-sm-30 py-sm-50 px-0 py-20 bg-white radius-xl w-100 mb-40">
                         <div class="row justify-content-center">
                            <div class="col-xxl-7 col-lg-10">
                                ...
                                <form method="post" action="{{ route('panel.videos.store') }}" enctype="multipart/form-data" >
                                    @csrf
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="add-product__body px-sm-40 px-20">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name"  class="form-control" id="name" value="{{old('name')}}" placeholder=" نام ویدیو ">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="slug" id="slug" placeholder="عنوان متا" value="{{old('slug')}}" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="description"
                                                                      ...
                                                                      placeholder="توضیحات بنویسید"  ></textarea>
                                                        </div>
